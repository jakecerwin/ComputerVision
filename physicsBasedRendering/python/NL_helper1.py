...
def displayAlbedosNormals(albedos, normals, s):
    ...
    if save:
        ...
        plt.savefig("../results/render_p3-2-albedo.png")
    ...
    if save:
        ...
        plt.savefig("../results/render_p3-2-normal.png")
...
def estimateShape(normals, s):
    ...
    if save:
        ...
        plt.savefig("../results/render_p3-2-depth.png")
...
def plotSurface(surface):
    ...
    if save:
        plt.savefig("../results/render_p3-2-3D_surface.png")
