...
def displayAlbedosNormals(albedos, normals, s):
    ...
    if save:
        ...
        plt.savefig("../results/render_p3-3-albedo.png")
    ...
    if save:
        ...
        plt.savefig("../results/render_p3-3-normal.png")
...
def estimateShape(normals, s):
    ...
    if save:
        ...
        plt.savefig("../results/render_p3-3-depth.png")
...
def plotSurface(surface):
    ...
    if save:
        plt.savefig("../results/render_p3-3-3D_surface.png")
